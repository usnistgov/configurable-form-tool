...
var fileDisplayTemplate = '<div class="_jsonform-preview">' +
  ...
  '<% } %>' +
  '</div>' +
  '<a href="#" class="btn btn-default _jsonform-delete"><i class="bi bi-x-lg" title="Remove"></i></a> ';
...
jsonform.elementTypes = {
  ...
  'textarea':{
    'template':'<textarea class="form-control" id="<%= id %>" name="<%= node.name %>" ' +
      '<%= (fieldHtmlClass ? "class=\'" + fieldHtmlClass + "\' " : "") %>' +
  ...
  'wysihtml5':{
    'template':'<textarea class="form-control" id="<%= id %>" name="<%= node.name %>" style="height:<%= elt.height || "300px" %>;width:<%= elt.width || "100%" %>;"' +
      '<%= (fieldHtmlClass ? "class=\'" + fieldHtmlClass + "\' " : "") %>' +
      '<%= (node.disabled? " disabled" : "")%>' +
      '<%= (node.readOnly ? " readonly=\'readonly\'" : "") %>' +
      '<%= (node.schemaElement && node.schemaElement.maxLength ? " maxlength=\'" + node.schemaElement.maxLength + "\'" : "") %>' +
  ...
  'ace':{
    ...
    'onInsert': function (evt, node) {
      var setup = function () {
        ...
        editor.getSession().setValue(JSON.stringify(node.value, null, '\t')||"");
  ...
  'checkbox':{
    'template': '<div class="form-check"><label><input type="checkbox" class="form-check-input" id="<%= id %>" ' +
      '<%= (fieldHtmlClass ? " class=\'" + fieldHtmlClass + "\'": "") %>' +
  ...
  'checkboxes':{
    ...
    'onBeforeRender': function (data, node) {
      ...
      var template = '<div class="form-check"><label>' +
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">' +
        '<a href="#" class="btn btn-primary _jsonform-array-addmore"><i class="bi bi-plus-lg" title="Add new"></i></a> ' +
        '<a href="#" class="btn btn-primary _jsonform-array-deletelast"><i class="bi bi-x-lg" title="Delete last"></i></a>' +
      '</span>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
      if ($('').sortable) {
        ...
        return '<li data-idx="<%= node.childPos %>">' +
          '<span class="draggable line"><i class=" btn btn-primary bi bi-list" title="Move item"></i></span>' +
          inner +
          '</li>';
      }
      else {
  ...
  'tabarray': {
    'template': '<div id="<%= id %>"><div class="tabbable tabs-left">' +
      ...
      '</div>' +
      '<a href="#" class="btn btn-primary _jsonform-array-addmore"><i class="bi bi-plus-lg" title="Add new"></i></a> ' +
      '<a href="#" class="btn btn-primary _jsonform-array-deleteitem"><i class="bi bi-x-lg" title="Delete item"></i></a></div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
  ...
  'submit':{
    'template':'<input type="submit" <% if (id) { %> id="<%= id %>" <% } %> style="margin-top:10px;" class="btn btn-primary <%= elt.htmlClass?elt.htmlClass:"" %>" value="<%= value || node.title %>"<%= (node.disabled? " disabled" : "")%>/>'
  },
  'button':{
