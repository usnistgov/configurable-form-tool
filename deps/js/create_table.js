                ...
                .then(dataTableColumns => { 
                    ...
                    data.results.forEach(element => {
                            ...
                            if(el.type==="string"){
                                ...
                                tableTest +="<td scope='row'> <a href="+element.content[el.property]+" target='_blank' rel='noopener noreferrer'>"+element.content[el.property]+"</a></td>";
                                ...
                                if (!!element.content) {
                                    ...
                                    tableTest += "<td>";
                                    tableTest += (!!element['id']) ? "<button type='button' class='btn btn-primary' onclick=OpenBtnPage('edit_" + element.content['@id'] + "_" + element['type'] + "')>"
                                    ...
                                    tableTest += (!!element['id']) ? "<button type='button' class='btn btn-danger' data-toggle='modal' data-target='#delete" + id[1] + "' >"
                                        ...
                                        + "</div>"
                                        : " ";
                                    tableTest += (!!element['id']) ? "<button type='button' class='btn btn-info' onclick=OpenBtnPage('view_" + element.content['@id'] + "_" + element['type'] + "')>"
